...
parser.add_argument('-m', '--model', default="llama-2-7b-chat.ggmlv3.q4_0.bin", help='Path to the LLaMa model')
parser.add_argument('-t', '--threads', default=4, type=int, help='Number of threads to use')
parser.add_argument('--max-tokens', default=256, type=int, help='The maximum number of tokens to generate')
...
init_prompt = '''Tu nombre es EDUAI, un asistente virtual desarrollado por las universidades Yachay Tech y UIDE en Ecuador. Tu propósito es brindar ayuda a estudiantes en matemáticas, tanto de colegios como de universidades.
